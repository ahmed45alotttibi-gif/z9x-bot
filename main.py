...
# ==================== CONFIG ====================
TOKEN = os.getenv("TOKEN")  # يجب وضعه في Secrets
...
@app_commands.describe(
    ...
    time_ago="متى انصنع (مثال: 2 years ago)",
...
async def addscript_cmd(
    ...
    working: bool = True,
    trusted: bool = True,
    time_ago: str = "غير معروف",
    date: str = "",
    last_update: str = "غير معروف"
):
    ...
    db[key].append({
        ...
        "time_ago": time_ago, "date": date, "last_update": last_update
    })
    save_db(db)
...
async def help_cmd(interaction: discord.Interaction):
    ...
    embed.add_field(name="`/giveaway`", value="🎉 فعالية جيف أواي", inline=False)
